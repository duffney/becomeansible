...
# -e "AZURE_SUBSCRIPTION_ID=dc4a17ec-4363-4f1e-b019-e71a4a15dc1c" \
# -e "AZURE_CLIENT_ID=c275ee75-0a3e-455c-8970-5cfb8b3283cd" \
# -e "AZURE_SECRET=P@ssw0rd12344321" \
# -e "AZURE_TENANT=e0d9abbc-a5c2-4590-aa27-86b9a8be4f6e" \
